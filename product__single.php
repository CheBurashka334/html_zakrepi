					...
					<div class="desc-text col l9 no-padding nofloat">
						...
						<div class="table col l5 nofloat no-padding">
							<div class="table-row no-padding col l12">
								<div class="table-col col l7">Гарантия</div>
								<div class="table-col col l5">1 год</div>
							</div>
							<div class="table-row no-padding col l12">
								<div class="table-col col l7">Крутящий момент</div>
								<div class="table-col col l5">185-250 Нм</div>
							</div>
							<div class="table-row no-padding col l12">
								<div class="table-col col l7">Мощность</div>
								<div class="table-col col l5">420 Вт</div>
							</div>
							<div class="table-row no-padding col l12">
								<div class="table-col col l7">Габаритная длина</div>
								<div class="table-col col l5">248 мм</div>
							</div>
							<div class="table-row no-padding col l12">
								<div class="table-col col l7">Вес</div>
								<div class="table-col col l5">2,2 кг</div>
							</div>
							<a class="tab-link" href="#tech">Посмотреть все характеристики</a>
						</div>
						<p>Вы можете купить Ударный гайковерт Hitachi WR 14 VB - NA 420 Вт в магазинах Крепыж по доступной цене. Ударный гайковерт Hitachi WR 14 VB - NA 420 Вт: описание, фото, характеритики, отзывы покупателей, инструкция и аксессуары.</p>
